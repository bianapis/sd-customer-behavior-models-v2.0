...
public class CustomerBehaviorModelsApiController {
	...
	@Design.Activate
	public BianResponse<SDCustomerBehaviorModelsActivateOutputModel> activate(@RequestBody BianRequest<SDCustomerBehaviorModelsActivateInputModel> bianRequest) {
	...
	@Design.Configure
	public BianResponse<SDCustomerBehaviorModelsConfigureOutputModel> configure(@PathVariable("sd-reference-id") String sdReferenceId, @RequestBody BianRequest<SDCustomerBehaviorModelsConfigureInputModel> bianRequest) {
		return BianResponse.forSuccess(service.configure(sdReferenceId, bianRequest.getData()));
	}
	
	@Design.Create
	public BianResponse<CRCustomerBehaviorModelSpecificationCreateOutputModel> create(@PathVariable("sd-reference-id") String sdReferenceId, @RequestBody BianRequest<CRCustomerBehaviorModelSpecificationCreateInputModel> bianRequest) {
	...
	@Design.Execute
	public BianResponse<CRCustomerBehaviorModelSpecificationExecuteOutputModel> execute(@PathVariable("sd-reference-id") String sdReferenceId, @PathVariable("cr-reference-id") String crReferenceId, @RequestBody BianRequest<CRCustomerBehaviorModelSpecificationExecuteInputModel> bianRequest) {
		return BianResponse.forSuccess(service.execute(sdReferenceId, crReferenceId, bianRequest.getData()));
	}
	
	@Design.Feedback
	public BianResponse<SDCustomerBehaviorModelsFeedbackOutputModel> feedback(@PathVariable("sd-reference-id") String sdReferenceId, @RequestBody BianRequest<SDCustomerBehaviorModelsFeedbackInputModel> bianRequest) {
	...
	@Design.Request
	public BianResponse<CRCustomerBehaviorModelSpecificationRequestOutputModel> request(@PathVariable("sd-reference-id") String sdReferenceId, @PathVariable("cr-reference-id") String crReferenceId, @RequestBody BianRequest<CRCustomerBehaviorModelSpecificationRequestInputModel> bianRequest) {
	...
	@Design.Retrieve
	public BianResponse<CRCustomerBehaviorModelSpecificationRetrieveOutputModel> retrieve(@PathVariable("sd-reference-id") String sdReferenceId, @PathVariable("cr-reference-id") String crReferenceId) {
	...
	@Design.RetrieveSD
	public BianResponse<SDCustomerBehaviorModelsRetrieveOutputModel> retrieveSD(@PathVariable("sd-reference-id") String sdReferenceId) {
